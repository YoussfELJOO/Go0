...
chsource = Redis:get(Fast..'chsource') or "source_rolexs"
devsource = Redis:get(Fast..'devsource') or "YouSsf_ELJOO"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5490392130,6787627484,6697982899}
...
if UserId == 6787627484 then
Status = true
elseif UserId == 9598866 then
Status = true
elseif UserId == 55555555555 then
Status = true
elseif UserId == 6697982899 then
Status = true
elseif UserId == 5555555555 then
Status = true
elseif UserId == 000000 then
Status = true
elseif UserId == 5490392130 then
Status = true
...
elseif UserId == 9598866 then
Status = 'مطـور السـورس '
elseif UserId == 00000000 then
Status = 'مـطـور الـسـورس'
elseif UserId == 6666666 then
Status = 'مطـور السـورس '
elseif UserId == Sudo_Id then  
...
elseif tonumber(Message) < 66979828991 then 
...
xname =  (Redis:get(Fast.."Name:Bot") or "[رولكس]") 
...
if tonumber(senderr) == 6787627484 then
msg.Name_Controller = 'المطور جو ❤️‍🔥  '
...
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
elseif tonumber(senderr) == 9598866 then
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
elseif tonumber(senderr) == 000000 then
msg.Name_Controller = 'مطور السورس '
msg.The_Controller = 1
elseif tonumber(senderr) == 6697982899 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 66666666 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
...
if msg.sender_id.user_id == tonumber(6787627484) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المطور جو نورت الجروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(9598866) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزي مطور السورس السورس ❤️‍🔥","md",true)
end
end5🙄
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(000000) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزي مطور السورس السورس ❤️‍🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "[رولكس]")
...
local name_amr = bot.getUser(66666666).first_name.." "..bot.getUser(66666666).last_name
local name_parlo = bot.getUser(6787627484).first_name.." "..bot.getUser(6787627484).last_name
local caption = "اليك قائمه مطورين سورس رولكس:"
if tonumber(UserId_Info.id) ~= 6787627484 then
...
data = {
{
{text = name_amr, data = msg.sender_id.user_id..'/DevShow@66666666'},
},
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@6787627484'},
},
LocalDev
,
{
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/source_rolexs ", 'md', true)
end
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(6787627484) then
...
if text == 'جو' or text == 'المبرمج جو' then
photo = "https://t.me/YouSsf_ELJOO"
local T =[[
[ٓ  ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε ՏøuƦcε ˼ 𓆪 𓆃](t.me/YouSsf_ELJOO )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐃𝐄𝐕 𝐉𝐎𝐎', url = "https://t.me/YouSsf_ELJOO"}
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒', url = "https://t.me/source_rolexs"}
},
}
...
photo = "https://t.me/source_rolexs"
local T =[[
— — — — — — — — —— — — 
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ💸 ⇣ الاوامر البنكيه ⇣ 💸 › .', url = "https://t.me/source_rolexs"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ☬ ⇣ اصنع بوتك الان ⇣ ☬ › .', url = "https://t.me/source_rolexs"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ☬ ⇣ اصنع بوتك الان ⇣ ☬ › .', url = "https://t.me/YouSsf_ELJOO"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'المبرمج' or text == 'جو' or text  == 'المطور جو' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(6787627484,0,'*\n◉  مرحباً عزيزي المطور جو \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒,━━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == "صورتي" then
...
if msg.sender_id.user_id == tonumber(6787627484) then
send(msg_chat_id,msg_id,"❍ انت جو مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(6697982899) then
send(msg_chat_id,msg_id,"❍ انت جو مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(0000000) then
send(msg_chat_id,msg_id,"❍ انت مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(55555) then
send(msg_chat_id,msg_id,"انتي [مطورت السورس] يقلبي 🥺♥","md",true)
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(6787627484) then
local txx = "\n"
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس',url="t.me/source_rolexs"}
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/source_rolexs"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@source_rolexs")
sleep(1)
...
{
{text = '.ˣ♡ اضغط لتنصيب بوتك ♡ˣ.', url = "https://t.me/YouSsf_ELJOO"}
},
{
...
if text == (Redis:get(Fast.."Name:Bot") or "رولكس") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "رولكس")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == 'جو' or text == 'مبرمج السورس' or text == 'joo' then  
local UserId_Info = bot.searchPublicChat("YouSsf_ELJOO")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '❲ المطور جو ❳', url = "https://t.me/YouSsf_ELJOO"}
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒', url = "https://t.me/source_rolexs"},
},
...
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[ٓ ˚₊· ͟͟͞͞➳❥❬ Welcome to source rolexs ❭• °](t.me/source_rolexs )
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n🤖╖ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "[رولكس]")..
'\n🎧╢• لأستخدام البوت اغاني وفيديو كول '..
'\n🎥╢• اكتب » /music ثم أضغط الأوامر .'..
'\n🕹╢اكتب /ROLEXS لاظهار كيبورد الاعضاء '..
...
'\n📣╢• ــــــــــــــــــــ𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒ــــــــــــــــ '..
'\n📣╢• تأكد » من تفعيل الرفع '..
