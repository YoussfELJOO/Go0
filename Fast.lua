...
video = "https://telegra.ph/file/76da65357aee0dc1cf29f.jpg"
local list = Redis:smembers(Fast.."total")
local JABWA = "*✭ عدد مشتركين بوتك『 "..#list.." 』مشترك*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐃𝐄𝐕 𝐉𝐎𝐎', url = 't.me/YouSsf_ELJOO '},
},
{
...
local UserId_Info = LuaTele.searchPublicChat("YouSsf_ELJOO")
...
local TestText = "*✯ مبرمج سورس جو ✭\n✯ ɴᴀᴍᴇ  >* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*✯ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/YouSsf_ELJOO"}
},
}
...
if text == '✭ سورس' or text == 'سورس' or text == 'يا سورس' or text == 'السورس' or text == 'source' then
photo = "https://t.me/source_rolexs"
local T =[[
[ٓ ˚₊· ‌➳❥❬ Welcome to source rolexs ❭ °](t.me/mhdippo )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '︎❪ 𝐃𝐄𝐕 𝐉𝐎𝐎 ❫', url = 't.me/YouSsf_ELJOO'},
},
{  
{text = '❪ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐑𝐎𝐋𝐄𝐗𝐒 ❫', url = 't.me/source_rolexs'},
},
